...
KBUILD_CFLAGS += -O3 -mcpu=cortex-a720 -mtune=cortex-x925 -mllvm -polly -mllvm -polly-ast-use-context -mllvm -polly-invariant-load-hoisting -mllvm -polly-loopfusion-greedy -mllvm -polly-run-inliner -mllvm -polly-vectorizer=stripmine -mllvm -polly-position=before-vectorizer
